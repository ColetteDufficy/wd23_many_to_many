...
#     return render_template("zombies/show.html", zombie=zombie, zombie_types = zombie_types)


# ALL_HUMANS_BITTEN_BY_SAME_ZOMBIE
@zombies_blueprint.route("/zombies/<id>")
def show(id):
    zombie = zombie_repository.select(id)
    humans = human_repository.select_all_victims_of_zombie(zombie)
